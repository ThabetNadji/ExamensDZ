              ...
              children: [
                Table(
                  ...
                  children: <TableRow>[
                    ...
                    TableRow(children: <Widget>[
                      tableRowOne('  إسلامية  ', Icons.brightness_low_outlined),
                      TextFormField(
                        inputFormatters: [
                          CustomRangeTextInputFormatter(),
                        ],
                    ...
                    TableRow(children: <Widget>[
                      tableRowOne(
                          '  تربية مدنية  ', Icons.account_balance_outlined),
                      TextFormField(
                        inputFormatters: [
                          CustomRangeTextInputFormatter(),
                        ],
                    ...
                    TableRow(children: <Widget>[
                      tableRowOne(
                          '  لغة أمازيغية  ', Icons.admin_panel_settings_sharp),
                    ...
                    onTap: () {
                      showDialog(
                        ...
                        builder: (context) {
                          ...
                          String _phyController = phyController.text.toString();
                          ...
                          String _engController = engController.text.toString();
                          double _engController_ =
                              double.tryParse(_engController);

                          String _frController = frController.text.toString();
                          ...
                          String _artController = artController.text.toString();
                          ...
                          return AlertDialog(
                            content: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Center(
                                      child: Text('معدل شهادة التعليم المتوسط',
                                          style: new TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: MediaQuery.of(context)
                                                    .size
