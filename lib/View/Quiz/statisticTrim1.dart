...
class statisticTrim1 extends StatelessWidget {
            ...
            Center(
              ...
              child: FutureBuilder(
                future: _quizService.getExamNumberOfTrim(
                    userGlobal.getUserInfo().getUserID(), 'first_trim'), // x
                  ...
                  if (snapshot.hasData) {
                    ...
                    if (snapshot.data.toString() != '-1') {
                      ...
                      return FutureBuilder(
                        future: _quizService
                            .getNumberOfExamsInTrim('first_trim'), // y
            ...
            Center(
              child: FutureBuilder(
                future: _quizService.getScoreOfTrim(
                    userGlobal.getUserInfo().getUserID(), 'first_trim'),
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    if (snapshot.data.toString() != '-1') {
                      return FutureBuilder(
